...
public:
    ...
    void Update(SDL_Renderer *renderer, const std::unique_ptr<AssetStore> &assetStore, const SDL_Rect &camera)
    {
        for (auto entity : GetSystemEntities())
        {
            ...
            SDL_Surface *surface = TTF_RenderText_Blended(assetStore->GetFont("pico-font-5"), healthText.c_str(), healthBarColor);
